...
AccountURI = "https://quantion.freshservice.com"
ProbeKey = ""
RegistrationKey="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJwb3J0YWxfdXJsIjoiaHR0cHM6Ly9xdWFudGlvbi5mcmVzaHNlcnZpY2UuY29tIn0.mxTaWva13KOoUixGgkdaUOTjc2jxb_IIS3uSL7MYFa8"
ProxyServer = ""
ProxyUserName = ""
ProxyPassword = ""
ProxyPort = ""
...
try:
    ...
    print(e)
execute_shell_command_ex_handled('tar -zxvf "{0}" -C "{1}"'.format(file_name, curr_dir))
